...
@php
$base = 'inline-flex items-center gap-2 px-3.5 py-2.5 rounded-xl text-sm font-medium focus-ring transition-all duration-150 transform-gpu hover:-translate-y-0.5 hover:shadow-panel';
$variants = [
